...
export const SET_FILTER = 'my-app/todos/SET_FILTER'

// FILTERS
export const FILTER_CURRENT = 'my-app/todos/FILTER_CURRENT'
export const FILTER_DONE = 'my-app/todos/FILTER_DONE'
